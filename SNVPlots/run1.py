...
if(os.path.isfile("obj/completedDonors1.pkl")):
    completed = dataParser.load_obj("completedDonors1")
else:
    completed = set()
...
for patient in patients[size+1: size+size+1]:
    ...
    try:
        ...
        dataParser.save_obj(completed, "completedDonors1")
        dataParser.save_obj(results, "GenewithDonorsWithSVsInGene1")
    except:
        continue
