...
if(os.path.isfile("obj/completedDonors2.pkl")):
...
for patient in patients[size + size + 1: size + size + size + 1]:
    if(os.path.isfile("obj/GenewithDonorsWithSVsInGene2.pkl")):
        results = dataParser.load_obj("GenewithDonorsWithSVsInGene2")
    else:
        results = {}
    ...
    try:
        ...
        dataParser.save_obj(completed, "completedDonors2")
        dataParser.save_obj(results, "GenewithDonorsWithSVsInGene2")
    except:
        continue
